...
final class TableConsoleTest {
	...
	void testToString() {
		...
		tableConsole.addRow(List.of("ETH", "40.41", "20458.96 USD", "ETH wallet, Binance, Coinspot, Defi"));
		...
		strExpectation.append(System.lineSeparator());
		strExpectation.append("  ETH |   40.41 | 20458.96 USD | ETH wallet, Binance, Coinspot, Defi");
		strExpectation.append(System.lineSeparator());
