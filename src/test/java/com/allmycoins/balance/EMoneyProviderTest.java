...
final class EMoneyProviderTest {

	private static final Supplier<CosmosJsProvider> GET_PROVIDER = () -> new CosmosJsProvider("EMONEY_ADDRESS",
			"emoney", "ungm", "NGM");
	...
	void testBalances() {
		...
		assertEquals("NGM", balance.getAsset());
		assertEquals("emoney wallet", balance.getSrc());
